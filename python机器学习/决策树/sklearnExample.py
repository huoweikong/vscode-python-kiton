...
np.random.seed(0) #keep random seeds consistent

#randn u=20 sigama=2 20 pots
...
w = clf.coef_[0]
a = -w[0]/w[1]          #calculate the slope(rake ratio/gradient)
xx = np.linspace(-5, 5)
...
print ("clf.coef_: ", clf.coef_) #w bias value
